...
export const PACKAGES: SafariPackage[] = [
  ...
  {
    slug: "rwanda-gorilla-golden-5",
    category: "gorilla-trekking",
    i18nKey: "rwandaGorillaGolden5",
    safariSlug: "rwanda-gorilla-golden-5-day",
    durationKey: "5d",
  },
  {
    slug: "rwanda-double-gorilla-8",
    category: "gorilla-trekking",
    i18nKey: "rwandaDoubleGorilla8",
    safariSlug: "rwanda-double-gorilla-golden-8-day",
    durationKey: "8d",
  },
  {
    slug: "rwanda-nyungwe-gorilla-10",
    category: "gorilla-trekking",
    i18nKey: "rwandaNyungweGorilla10",
    safariSlug: "rwanda-nyungwe-double-gorilla-golden-10-day",
    durationKey: "10d",
  },
  /** @deprecated Use rwanda-gorilla-golden-5 — kept for old links */
  { slug: "rwanda-gorilla", category: "gorilla-trekking", i18nKey: "rwandaGorilla", safariSlug: "rwanda-gorilla-golden-5-day", durationKey: "5d" },
